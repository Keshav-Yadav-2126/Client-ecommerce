...
const ProductDetails = () => {
    ...
    if (getCartItems.length) {
      ...
      if (indexOfCurrentItem > -1) {
        ...
        if (getQuantity + quantity > productDetails.stock) {
          toast.error(
            `Only ${productDetails.stock - getQuantity} more items available`
          );
          return;
        }
      }
  ...
  const getRatingDistribution = () => {
    ...
    reviews.forEach((review) => {
      distribution[review.reviewValue] =
        (distribution[review.reviewValue] || 0) + 1;
    });
    return distribution;
  };
      ...
      <div className="container mx-auto px-4 py-4 md:py-6 lg:py-8 max-w-7xl">
          ...
          <div className="space-y-4 md:space-y-6">
            <div>
              <div className="flex items-center gap-2 md:gap-3 mb-2 flex-wrap">
                <Badge
                  variant="outline"
                  className="border-blue-300 text-blue-700 bg-blue-50 text-xs md:text-sm"
                >
                  {productDetails.category}
                </Badge>
                <Badge
                  variant="outline"
                  className="border-yellow-400 text-yellow-700 bg-yellow-50 text-xs md:text-sm"
                >
                  ...
                  <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          setQuantity(
                            Math.min(productDetails.stock, quantity + 1)
                          )
                        }
                  ...
                  <div className="mb-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                    <p className="text-sm text-orange-800 text-center font-medium">
                      ...
                      <span
                        ...
                        className="underline cursor-pointer hover:text-orange-900 font-semibold"
                      >
                        login
                      </span>{" "}
        ...
        <div className="mt-8 md:mt-12">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem
              value="ingredients"
              className="border-yellow-200 bg-white/50 rounded-lg mb-4 px-4 md:px-6"
            >
            ...
            >
              ...
              <AccordionContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 pt-4">
                  ...
                  productDetails.keyBenefits.length > 0 ? (
            ...
            <AccordionItem
              value="reviews"
              className="border-yellow-200 bg-white/50 rounded-lg px-4 md:px-6"
            >
              <AccordionTrigger className="text-base md:text-lg font-semibold text-gray-800 hover:text-yellow-700">
                <div className="flex items-center gap-2">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          {[5, 4, 3, 2, 1].map((stars) => (
                            ...
                            >
                              <span className="text-xs md:text-sm font-medium w-8">
                                {stars} ★
                              </span>
                      ...
                      {!hasPurchased && (
                        <Alert className="mb-4 border-orange-300 bg-orange-50">
                          ...
                          <AlertDescription className="text-xs md:text-sm text-orange-800">
                            You must purchase this product before writing a
                            review.
                          </AlertDescription>
                        </Alert>
                      )}
                  ...
                  <div className="space-y-4">
                    ...
                    {reviews && reviews.length > 0 ? (
                      reviews.map((reviewItem, index) => (
                        <Card
                          key={index}
                          className="bg-white border border-gray-200 hover:border-yellow-300 transition-all hover:shadow-md"
                        >
